...
<head>
  ...
  <link rel="stylesheet" href="myCss/addUtilization.css">
    ...
    <div id="content-wrapper" class="d-flex flex-column">
      ...
      <div id="content">
        ...
        <div class="container-fluid">
         ...
         <div class="row">
          <select class="add">
            <option value="" disabled selected>Select Utilization</option>
          ...
          <button class="records" type="button">Show Records</button>
          </div>
        </div>
        ...
        <div class="container">
          ...
          <div class="row">
              <button class="submitBill" type="submit">Enter Details</button>
            </div>
        </div>
